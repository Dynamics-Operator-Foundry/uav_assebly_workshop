...
## 1. What to buy.
- Follow this [file](buy_hardware.docx) to buy all the things your need. 
...
3. Load firmware to the FCU. Open QGC, and go to "Firmware" to upload ```.px4``` to FCU. Note that you should tick on "advance settings", and then select "Custom firmware file..." under the drop-down options.
   ...
   <div align=center>
   <img src="figures/custom_firmware.png"/>
   </div>
...
4. If you want to build from source on your own, refer to [this](.fcu.md)
...
<div align=center>
<img src="figures/modesetting.png">
</div>
...
<div align=center>
<img src="figures/actuators_cali.png" width="480">
</div>
...
<div align=center>
<img src="figures/uav.png" width="350">
</div>
...
<div align=center>
<img src="figures/motor_cali.png" width="350">
</div>
